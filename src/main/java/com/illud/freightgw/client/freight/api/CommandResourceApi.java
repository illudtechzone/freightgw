...
public interface CommandResourceApi {
    ...
    @ApiOperation(value = "customerStatus", nickname = "customerStatusUsingPOST", notes = "", tags={ "command-resource", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> customerStatusUsingPOST(@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId,@ApiParam(value = "customerStatus" ,required=true )  @Valid @RequestBody CustomerStatus customerStatus);
