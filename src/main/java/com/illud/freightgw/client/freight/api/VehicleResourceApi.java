...
public interface VehicleResourceApi {
    ...
    @ApiOperation(value = "createVehicleDtoList", nickname = "createVehicleDtoListUsingPOST", notes = "", response = VehicleDTO.class, responseContainer = "List", tags={ "vehicle-resource", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<List<VehicleDTO>> createVehicleDtoListUsingPOST(@ApiParam(value = "list" ,required=true )  @Valid @RequestBody List<Vehicle> vehicle);


    @ApiOperation(value = "createVehicleDto", nickname = "createVehicleDtoUsingPOST", notes = "", response = VehicleDTO.class, tags={ "vehicle-resource", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/convertToVehicleDto",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<VehicleDTO> createVehicleDtoUsingPOST(@ApiParam(value = "vehicle" ,required=true )  @Valid @RequestBody Vehicle vehicle);
